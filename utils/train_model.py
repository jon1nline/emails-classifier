...
model = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels=2) # 2 categorias
...
print("Treinamento concluído. O modelo e o tokenizador foram salvos em './fine_tuned_model'.")