"""
Django settings for smart_mail_classifier project.
...
SECRET_KEY = "django-insecure-vaa@2zu$%erhkyptxmr$lh+18j%e$l(98y+mcszc0(5mr_g_sh"
...
ROOT_URLCONF = "smart_mail_classifier.urls"
...
WSGI_APPLICATION = "smart_mail_classifier.wsgi.application"
